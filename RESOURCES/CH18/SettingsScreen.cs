function SetupScreen::setPane(%this, %pane)
{
...
function SetupScreen::onWake(%this)
{
...
function SetupScreen::onSleep(%this)
{
...
function SetupScreen::applyGraphics( %this )
{
	...
	if ( %newDriver !$= $pref::Video::displayDevice )
	{
		...
		//SetupScreen::deviceDependent( %this );
	}
	else
